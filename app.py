...
def index():
    ...
    if request.method == 'POST':
        ...
        if not mediafire_url:
            return render_template('index.html', error='⚠️ الرجاء إدخال رابط صحيح')
...
def player(page_id):
    ...
    if time.time() - link_info['time'] > 1800:
        ...
        return "⚠️ انتهت صلاحية الرابط", 404
